...
#     quit()
    ...
    cheerup_comment = ('수고했어요, 오늘도', '힘을 내요 슈퍼파워', '잘했어, 내일도 잘할거야')

    import random
    cheerup_comment = random.choice(cheerup_comment)
    ...
    'rest_day':round(rest_day, 2), 'rest_time':round(rest_time, 2), 'daytime_attendance_dict':daytime_attendance_dict,
            ...
            'comment':comment, 'phrase': phrase, 'cheerup_comment': cheerup_comment}
